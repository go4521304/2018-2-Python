...
class Boy:
    ...
    def fire_ball(self, big):
        ...
        self.way_x = math.fabs(self.x - self.way_x)
        self.way_y = math.fabs(self.y - self.way_y)
        mag *= 0.003*self.way_x
        ballSpeed = mag * self.speed + self.dx
        ySpeed = 2 * self.speed * (1+0.003*self.way_y)
        ballSpeed = ballSpeed * (self.way_x / math.sqrt(self.way_x**2 + self.way_y**2))
        ySpeed = ySpeed * (self.way_y / math.sqrt(self.way_x**2 + self.way_y**2))
